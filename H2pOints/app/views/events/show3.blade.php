    ...
    <div id="wrapper">
        ...
        <div class="container-fluid marginTop">
            <div class="text-center col-sm-6 col-sm-offset-3">
                <h1 class="white text-center">Conferència sobre el consum de l'aigua</h1>
                <img class="profile-img img-rounded" src="../img/consum-aigua.jpg" alt="Profile image">
                <table class="white profile-table text-left">
                    <tr>
                        <td>Descripció</td>
                        <td>Conferència sobre el consum de l'aigua a la sala àgora del museu.</td>
                    </tr>
                    <tr>
                        <td>Lloc</td>
